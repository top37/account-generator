...
import static com.sq.account.generator.utils.StringUtils.strBrackets;
            ...
            if(isDebit(a)){
                ...
                if(i != 0 && i+1<=lstAccount.size() && isDebit(lstAccount.get(i-1)) && !isDebit(lstAccount.get(i+1))){
                    ...
                    while (j != 0 && isDebit(lstAccount.get(j)) ){
                        ...
                        AccountNew an = new AccountNew.Builder().b(cj).c("5551").d("").e("156").f("").g(strBrackets(am1.get(key))).h("").i("N").j("").k("").l("100").m(aj.getG()).n(StringUtils.strC2E(aj.getF())).o(StringUtils.strRedOrBlue(aj.getH())).p(aj.getE()).q("ZB"+Integer.toString(c)).r(aj.getJ()).s(az.getG()).t(StringUtils.strC2E(az.getF())).u(StringUtils.strRedOrBlue(az.getH())).v(az.getE()).w("ZB"+Integer.toString(c)).x(az.getJ()).build();
                ...
                AccountNew an = new AccountNew.Builder().b(cj).c("5551").d("").e("156").f("").g(strBrackets(am1.get(key))).h("").i("N").j("").k("").l("100").m(g).n(StringUtils.strC2E(f)).o(StringUtils.strRedOrBlue(rorb)).p(desc).q("ZB"+Integer.toString(c)).r(au).s(az.getG()).t(StringUtils.strC2E(az.getF())).u(StringUtils.strRedOrBlue(az.getH())).v(az.getE()).w("ZB"+Integer.toString(c)).x(az.getJ()).build();
                m.putIfAbsent(an.toString(),an);
            }
        }
